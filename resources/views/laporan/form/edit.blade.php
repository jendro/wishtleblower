                ...
                <div class="col-md-7">
                    ...
                    <form method="post" action="{{ route('laporan.create') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input required required type="text" class="form-control" id="nama_pelapor" name="nama_pelapor">
                        </div>
                        <div class="form-group">
                            <label for="telepon_pelapor">Telepon Pelapor</label>
                            <input required type="text" class="form-control" id="telepon_pelapor" name="telepon_pelapor">
                        </div>
                        <div class="form-group">
                            <label for="email_pelapor">Email Pelapor</label>
                            <input required type="text" class="form-control" id="email_pelapor" name="email_pelapor">
                        </div>
                        <hr>
                        <h4 class="form-title">Terlapor</h4>
                        <div class="form-group">
                            <label for="nama_terlapor">Nama Terlapor</label>
                            <input required type="text" class="form-control" id="nama_terlapor" name="nama_terlapor">
                        </div>
                        <div class="form-group">
                            <label for="jabatan_terlapor">Jabatan Terlapor</label>
                            <input required type="text" class="form-control" id="jabatan_terlapor" name="jabatan_terlapor">
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_laporan_id" id="jenis_laporan_id" class="form-control">
                                ...
                                @foreach($jenis_laporan_r as $jenis_laporan_id=>$jenis_laporan)
                                    <option value="{{ $jenis_laporan_id }}">{{ $jenis_laporan }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="waktu_kejadian">Waktu Kejadian</label>
                            <input required type="text" class="form-control" id="waktu_kejadian" name="waktu_kejadian" placeholder="misal : sekitar bulan desember, sore hari tanggal 17 maret 2019">
                        </div>
                        <div class="form-group">
                            <label for="lokasi_kejadian">Lokasi Kejadian</label>
                            <input required type="text" class="form-control" id="lokasi_kejadian" name="lokasi_kejadian">
                        </div>
                        <div class="form-group">
                            <label for="kronologis_kejadian">Kronologis Kejadian</label>
                            <textarea required name="kronologis_kejadian" id="" cols="30" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="detail_kejadian">Detail Kejadian</label>
                            <textarea required name="detail_kejadian" id="" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group">
